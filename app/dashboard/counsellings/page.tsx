    ...
    <section className="w-full h-screen px-4 py-16 overflow-y-auto bg-white dark:bg-black-100">
      ...
      <div className="flex justify-between w-full mt-10">
        <div className="w-[33%] overflow-y-auto ">
          <ul className="w-full">
            <li onClick={()=>window.location.replace('/dashboard/counsellings/All-India-Counselling')} className="w-full p-3 mt-3  border border-gray-300 rounded-md cursor-pointer first:mt-0 dark:border-gray-800 hover:bg-gray-115  dark:hover:bg-black bg-white dark:bg-black-100">
        ...
        <div className=" w-[65%]   border border-gray-300 rounded-md dark:border-gray-800">
          ...
          <div className="p-7 ">
            <p className="text-xl text-gray-500">
              Select a counselling to see details
            </p>
          </div>
        </div>
      </div>
