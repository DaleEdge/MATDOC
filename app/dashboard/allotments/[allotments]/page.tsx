...
import FilterBox from "@/app/components/fiterbox"
...
export default function Page(){
  const [filter,setFilter] = useState(false)
    ...
    return (
        ...
        <div id="root">
          {filter &&
          <div onClick={()=>setFilter(!filter)} className="absolute z-10 bg-black bg-opacity-70 h-screen w-screen flex items-center content-center">
              
              <div onClick={()=>(console.log('nope'))} className="my-auto mx-auto"><FilterBox></FilterBox></div>
          </div>
}
      ...
      <div className="w-full p-5 border border-gray-300 rounded-md mt-7 dark:border-gray-800">
        <div className="flex items-center justify-between ">
          ...
          onClick={()=>setFilter(!filter)}
            type="button"
            className="flex items-center justify-center h-10 px-3 py-1 text-base border rounded border-orange-250 text-orange-250 w-fit gap-x-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width={18}
