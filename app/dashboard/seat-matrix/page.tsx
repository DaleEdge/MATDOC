        ...
        <div className="flex items-center justify-between w-full gap-x-7 ">
          ...
          <div className="w-[60%] flex justify-end items-center gap-x-4">
            <ul className="flex items-center justify-between dark:text-white gap-x-4">
              ...
              <li onClick={()=>window.location.replace('/dashboard/profile')} className="text-base font-semibold hover:bg-gray-400/20 dark:hover:bg-gray-300/20 py-1.5 px-3 rounded-lg text-black dark:text-white">
    ...
    <section className="w-full h-screen px-4 py-16 overflow-y-auto bg-white dark:bg-black-100">
      ...
      <div className="w-full">
        <ul className="w-full mt-4">
          <li onClick={()=>window.location.replace("/dashboard/seat-matrix/c")}  className="relative p-3 border-b border-gray-200 rounded-md cursor-pointer last:border-b-0 dark:border-gray-800 group hover:bg-gray-115">
