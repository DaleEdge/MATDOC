      ...
      >
        <div className="flex items-center justify-between w-full gap-x-7 ">
          ...
          <div className="w-[60%] flex justify-end items-center gap-x-4">
            ...
            <div className="relative flex items-center justify-end h-auto cursor-pointer w-fit ">
      ...
      <div className="w-full p-5 border border-gray-300 rounded-md mt-7 dark:border-gray-800">
        <div className="flex items-center justify-between ">
          <p className="text-sm text-black dark:text-white">
            {" "}
            1 - 3 of 73524 Records in 2023 session
          </p>
        </div>
          ...
          <table className="w-full mt-5 text-sm">
            <thead>
              <tr className="text-black bg-gray-300 rounded-md dark:text-white ">
                ...
                <th className="text-sm px-1.5 py-2 text-nowrap  text-left rounded-r-md">
                  BEDS
                </th>
              </tr>
            </thead>
            <tbody>
              <tr className="pb-3 border-b border-gray-300 last:border-0 dark:border-gray-800">
                <td className="text-sm px-1.5 py-2  text-left">Karnataka</td>
                <td className="text-sm px-1.5 py-2  text-left text-blue-500">
                  VIMS,Bellary
                </td>
                <td className="text-sm px-1.5 py-2  text-left">ORTHODICS</td>
                <td className="text-sm px-1.5 py-2  text-left">AIQ</td>
                <td className="text-sm px-1.5 py-2  text-left">114000</td>
                <td className="text-sm px-1.5 py-2  text-left">₹45,000*</td>
                <td className="text-sm px-1.5 py-2  text-left">3*</td>
                <td className="text-sm px-1.5 py-2  text-left">5000000</td>
                <td className="text-sm px-1.5 py-2  text-left">₹1295</td>
              </tr>
              <tr className="pb-3 border-b border-gray-300 last:border-0 dark:border-gray-800">
                <td className="text-sm px-1.5 py-2  text-left">Karnataka</td>
                <td className="text-sm px-1.5 py-2  text-left text-blue-500">
