    ...
    <section className="w-full h-screen px-4 py-16 overflow-y-auto bg-white dark:bg-black-100">
      ...
      <div className="w-full">
        <ul className="w-full mt-4">
          <li onClick={()=>window.location.replace("/dashboard/closing-ranks/c")}  className="relative p-3 border-b border-gray-200 rounded-md cursor-pointer last:border-b-0 dark:border-gray-800 group hover:bg-gray-115">
