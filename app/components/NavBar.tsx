              ...
              <li className=" mt-1.5 relative group text-black dark:text-white ">
                <div>
                  ...
                  <ul className="mt-1.5">
                    ...
                    <li className="  mt-1 relative group  ">
                      <a
                        className="flex justify-start items-center gap-x-2 pl-6 hover:bg-gray-400/20 dark:hover:bg-gray-300/20  py-1.5  group duration-300 text-base ease-in-out transition capitalize   "
                        href="/dashboard/seatIncrease"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
